      ...
      <div className="bg-surface rounded-lg shadow-2xl border border-line flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-150">
        ...
        <div className="h-14 bg-surface-2 hairline-t px-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onClose}
              className="px-4 py-2 rounded bg-surface border border-line text-ink hover:bg-surface-2 text-xs font-semibold"
            >
              إغلاق
            </button>
            <button
              onClick={handlePrint}
              className="flex items-center gap-2 px-5 py-2 rounded bg-brand text-white hover:bg-brand-container text-xs font-bold shadow-sm"
            >
