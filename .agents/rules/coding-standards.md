...
### 🔴 5. الالتزام الصارم بالتسلسل الزمني للباك لوج ومنع القفز (Strict Sequential Execution)
- يُمنع منعاً باتاً على أي وكيل أو مطور القفز إلى محطة تالية أو ميزة لاحقة قبل إنهاء كافة التاسكات غير المنجزة `[ ]` في المحطة الحالية داخل [`PROJECT_BACKLOG.md`](./PROJECT_BACKLOG.md).
- الأولوية المطلقة دائماً للبنية التحتية، الأمان، حماية البيانات، واستقرار النظام (المحطة 1 ثم 2 ثم 3...)، ولا يجوز إطلاقاً تقديم واجهات بصرية على حساب المهام التأسيسية المعلقة.
- قبل بدء أي مهمة برمجية، يتم فحص أول خانة غير مكتملة `[ ]` تسلسلياً في الباك لوج والعمل عليها حصراً.
